...
[Modern JavaScript]([https://link](https://en.wikipedia.org/wiki/ECMAScript#:~:text=ECMAScript%20(or%20ES)%20is%20a,pages%20across%20different%20Web%20browsers.)) / `ECMA Script 6+` will be used in this project as the main programming language.

### **Framework**
We chose to build our web app with `React` framework. See the [Getting Started]([https://link](https://reactjs.org/docs/getting-started.html)) guide. Quick start guide on how to [create a new React app]([https://link](https://reactjs.org/docs/create-a-new-react-app.html)).
...
Click on [this link]([https://link](https://github.com/QuangTran304/Instagram-Clone)) to visit our repository.

## **Our To-do list**
All the tasks assigned to each team member are listed on a `Google Sheet`.
Click on [this link]([https://link](https://docs.google.com/spreadsheets/d/1X7ElBQj5sJhMfGpT3BbRrOHFpmPM4YAUXYG36gEabS8/edit?usp=sharing)) to view the To-do list.
...
| Redux | I don't have experience working with Redux but I'll learn it soon. [Watch]([https://link](https://www.youtube.com/watch?v=poQXNp9ItL4)) |
